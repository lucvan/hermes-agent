...
def _build_child_agent(
    ...
    # _resolve_delegation_credentials always pairs override_provider with
    # override_base_url (full bundle resolved together, or neither set), so
    # this stays atomic: an override never mixes with a stale parent field.
