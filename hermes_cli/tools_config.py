...
CONFIGURABLE_TOOLSETS = [
    ...
    ("whatsapp-extras",  "💬 WhatsApp (arbitrary contact)", "send/read messages, list contacts beyond the current chat"),
...
_DEFAULT_OFF_TOOLSETS = {"homeassistant", "spotify", "discord", "discord_admin", "video", "video_gen", "x_search", "a2a", "whatsapp-extras"}
